...
public class HomePage extends javax.swing.JFrame {
    ...
    String fileNameUser = LogIn.filename;
    ...
    public void aksi(){
        try {
            ...
            Image img = icon.getImage().getScaledInstance(ImageAvatar2.getWidth(), ImageAvatar2.getHeight(), Image.SCALE_SMOOTH);
            ImageIcon ic = new ImageIcon(img);
            ImageAvatar2.setIcon(ic);
        } catch (Exception e) {
        }
        ...
        try {
            ...
            if(rs.next()){
                this.namaProduct = rs.getString("nama");
    ...
    public void aksiShowSaldo(){
        try {
            ...
            String sql = "SELECT * FROM biodata WHERE email= '"+email
            +"'";
            rs = st.executeQuery(sql);
            if (rs.next()){
    ...
    private void initComponents() {
        ...
        ImageAvatar2 = new desain.ImageAvatar();
        ...
        ImageAvatar2.setImage(new javax.swing.ImageIcon(getClass().getResource("/assets/default.png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(ImageAvatar2, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(379, 379, 379))
        );
        ...
        txtNominal.setText("Masukan nominal top up");
        ...
        jLabel2.setText("Nominal Top Up");
        ...
        jLabel5.setPreferredSize(new java.awt.Dimension(80, 38));
        ...
        jLabel3.setText("Penawaran Hari Ini");
    ...
    private void txtNominalFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNominalFocusGained
        ...
        if(txtNominal.getText().equals("Masukan nominal top up")){
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        String tambahSaldo = txtNominal.getText();
        if (tambahSaldo.equals("Masukan nominal top up")){
            ...
            try {
                ...
                amountInt += Integer.parseInt(tambahSaldo);
                saldo = amountInt;
            ...
            try {
                ...
                String sql = "UPDATE biodata SET saldo = " + amountInt+ " WHERE email = '" + email + "'";
    ...
    private desain.ImageAvatar ImageAvatar2;
